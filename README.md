...
https://drive.google.com/file/d/1b1-m9mw_8WB3aAkeMXedzdMleiZb2KMR/view?usp=sharing

A quick walkthrough of the setup and monitoring flow — spinning up the stack with `docker compose up -d --build`, then registering a healthy, a slow, and a broken URL to show status tracking, response times, and incident creation in real time.

## Screenshots

![Dashboard showing a healthy URL](screenshots/Screenshot_2.png)
